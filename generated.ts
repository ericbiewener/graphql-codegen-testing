...
type SomeFragment_Person_Fragment = { name: string, age: number };
...
export type GetFooQuery = { foo?: Maybe<{ id: string, meta?: Maybe<{ data?: Maybe<SomeFragment_Person_Fragment> }> }> };
...
export type GetFooFoo = (NonNullable<GetFooQuery['foo']>);
export type GetFooMeta = (NonNullable<(NonNullable<GetFooQuery['foo']>)['meta']>);
export type GetFooData = (NonNullable<(NonNullable<(NonNullable<GetFooQuery['foo']>)['meta']>)['data']>);